...
export const ANNOUNCEMENT_FIELDS = {
  ...
  events: [
    ...
    { key: "status", label: "Status", type: "select", options: ["upcoming", "ongoing", "past"], required: true },
    ...
    { key: "images", label: "Event Images", type: "image-list", hiddenWhenUpcoming: true },
    { key: "coverImageUrl", label: "Homepage Cover Image", type: "cover-selector", hiddenWhenUpcoming: true },
