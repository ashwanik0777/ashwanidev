...
export const departmentLayoutData = {
  ...
  programsData: [
    { title: "M.A. Buddhist Studies (Language Focus)", duration: "2 Years", intake: "20 Students", description: "Specialized focus on Pali and Sanskrit language training.", image: "https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?auto=format&fit=crop&w=400&q=80", gradient: "from-orange-500 to-yellow-600", highlights: ["Pali Grammar", "Sanskrit for Buddhist Studies", "Canonical Literature", "Translation Methods"] },
    { title: "Ph.D. Buddhist Languages", duration: "3-5 Years", intake: "5 Students", description: "Original research in Buddhist philology and textual criticism.", image: "https://images.unsplash.com/photo-1481627834876-b7833e8f5570?auto=format&fit=crop&w=400&q=80", gradient: "from-amber-500 to-orange-600", highlights: ["Textual Criticism", "Comparative Philology", "Digital Text Analysis", "Thesis Defense"] },
  ],
  facultyMembers: [
