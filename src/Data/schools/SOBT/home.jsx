  ...
  },
{
    ...
    props: {
      data: {
        ...
        floatingIcons: [
          { icon: <Code size={40} />, color: "text-emerald-400", style: "top-20 left-10" },
          { icon: <Lightbulb size={35} />, color: "text-teal-400", style: "top-32 right-20" },
            ...
            content: (
              <>
                ...
                <span className="font-semibold text-emerald-600">
                  School of Biotechnology at Gautam Buddha University (GBU)
                </span>{" "}
                is a premier institution dedicated to both teaching and research in the field of biotechnology. Established in 2009 by the Government of Uttar Pradesh, the school provides a{" "}
                <span className="font-semibold text-teal-600">
                  state-of-the-art learning environment
                </span>
                , featuring centrally air-conditioned facilities, advanced research laboratories, and round-the-clock internet connectivity. With a science- and technology-oriented curriculum, the school aims to bridge the gap between academic knowledge and industry demands.
              </>
            ),
          },
          {
            ...
            content: (
              <>
                ...
                across genetics, molecular biology, bioinformatics, and microbial biotechnology through innovative pedagogy and hands-on laboratory experience. The school emphasizes{" "}
                <span className="font-semibold text-emerald-600">
                  patenting innovations, technology transfer
                </span>
                , and industrial collaborations, generating a highly trained workforce to meet global healthcare, agricultural, and research demands.
              </>
            ),
          },
        ],
    ...
    props: {
      ...
      facultyList: [
        ...
        },
        {
          ...
          image:
            "https://faculty.gbu.ac.in/uploads/photos/66ad254325f87_Picture1.jpg",
        },
        {
          name: "Dr. Prafullakumar B. Tailor",
          title: "Adjunct Professor",
          image:
            "https://faculty.gbu.ac.in/uploads/photos/6881e98393b0a_tailor.jpeg",
        },
        {
          name: "Dr. Pramod R. Yadav",
          title: "Adjunct Professor",
          image:
            "https://faculty.gbu.ac.in/uploads/photos/6881e5e6e154a_pramodyadav.jpg",
        },
        {
          name: "Dr. Shalini Rai",
          title: "Assistant Professor – CSE",
          image:
            "https://faculty.gbu.ac.in/uploads/photos/6881e837d0124_Dr-Shalini.jpg",
        },
        {
        ...
        },
        {
          ...
          title: "Assistant Professor",
          image:
            "https://faculty.gbu.ac.in/uploads/photos/660535f24a586_bhupendra.jpg",
        },
        {
        ...
        },
        {
          ...
          title: "Assistant Professor",
          image:
            "https://faculty.gbu.ac.in/uploads/photos/660535a7c46a1_gunjangarg.jpg",
        },
      ],
    },
  },
...

  {
    ...
    props: {
      data: {
        ...
        subheading:
          "Our biotechnology students placed in leading pharma and research companies",
      ...
      achievements: [
        {
          ...
          image:
            "https://images.unsplash.com/photo-1581091870622-9c6c63c67f1f?w=400",
          description:
