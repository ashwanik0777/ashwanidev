...
export const coeDroneData = {
  ...
  about: {
    ...
    storyText:
      "The Centre of Excellence – Drone Technology (CEDT) is a pioneering initiative that combines academics, industry, and policy to develop future-ready drone capabilities.",
    whatWeDoTitle: "What We Do",
    whatWeDoText:
      "CEDT offers drone pilot training, data processing and analysis, and hands-on R&D in aerial robotics, sensing, and intelligent systems.",
    commitmentTitle: "Our Commitment",
    commitmentText:
      "We are dedicated to systematizing knowledge, building capacity, and enabling responsible use of drones across critical sectors.",
    photos: [
  ...
  mentors: [
    {
      type: "GBU",
      image: "https://ui-avatars.com/api/?name=Prof+Rana+Pratap+Singh&background=0D8ABC&color=fff&size=200",
  ...
  partners: [
    {
      ...
      description:
        "India's leading drone-based services company with expertise in drone manufacturing, aerial mapping, and robotics solutions.",
      image: omnipresent,
      year: "2021",
    },
    {
      ...
      description:
        "Committed to developing a skilled workforce in instrumentation, automation, and communication through specialized training programs.",
  ...
  course: {
    ...
    sectionSubtitle: "Empowering hands-on expertise in drone manufacturing, flight concepts, & piloting",
    imageSrc: droneImage,
    imageAlt: "Drone Training Course",
    badgeText: "FLAGSHIP",
    courseTitle: "Training & Certification in Drone Designing & Piloting",
    courseDescription:
      "Our first flagship Certificate course of “Training and Certification in Drone Designing and Piloting” leading to Drone Pilot Certification as well as assembling and getting expertise featuring agriculture, mapping, and flood damage applications.",
    duration: "5 Weeks + 1 Week Extended",
    modeDetails: "Regular Mode: 5 days a week (3 hours Theory + 5 Hours Hands-on Making, Assembling, and Maintenance of Drones per day, including 25 hours hands-on drone flying practice).",
    price: "₹49,000",
    ...
    highlights: [
      ...
      "Detailed insight about Drones and their real-time Applications",
      "Available Jobs in different fields",
      "Job placement Assistance",
      "Application/Industry-specific Drone Training",
      "Autonomous Drones handling",
      "Practical Flood Damage Assessment",
      "Geo Referencing and Agricultural Application Featuring Design and Practising",
  ...
  facilities: [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1527977966376-1c8408f9f108?w=800&auto=format&fit=crop",
    },
    {
      title: "Flying Zone",
      description:
  ...
  mediaItems: [
    {
      ...
      date: "2022-04-23",
      image:
        "https://static.wixstatic.com/media/bc6a73_ed122f7cc89e48619d459f4272eba491~mv2.jpg",
      description:
        "Gautam Buddha University to launch drone pilot training courses with short-term modules for aspiring drone operators.",
      link:
        "https://www.navodayatimes.in/news/khabre/drone-pilot-will-also-now-have-a-course-in-gautam-buddha-university/197826/",
    },
    {
    ...
    },
    {
      ...
      date: "2022-05-01",
      image:
        "https://static.wixstatic.com/media/bc6a73_009334d175304d4485f3f7eabe50dad5~mv2.jpeg/v1/fill/w_815,h_358,al_c,lg_1,q_80,enc_avif,quality_auto/11062b_fd5c21cdc57f4b19b00f8ec0988396fe_.jpeg",
      description:
        "Three new drone technology programs launching at GBU to support youth employment and skilling in drone manufacturing, piloting, and technology.",
      link:
        "https://www.patrika.com/noida-news/gautam-buddha-university-will-conduct-3-type-short-term-drone-course-7470045",
    },
    {
      title: "GBU to Become Smart Campus with Drone Manufacturing & Training",
      date: "2022-06-01",
      image:
        "https://static.wixstatic.com/media/bc6a73_d4a5adff6b184bd39773f481faab5635~mv2.jpg/v1/fill/w_815,h_358,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/11062b_fd5c21cdc57f4b19b00f8ec0988396fe_.jpg",
      description:
        "New developments at GBU to open employment avenues through drone manufacturing and pilot training initiatives.",
      link: "",
    },
    {
      ...
      date: "2022-05-27",
      image:
        "https://static.wixstatic.com/media/bc6a73_39c8b7fad71449f4814235f25c45bf6f~mv2.jpg/v1/fill/w_792,h_347,al_c,lg_1,q_80,enc_avif,quality_auto/11062b_fd5c21cdc57f4b19b00f8ec0988396fe_.jpg",
      description:
        "Gautam Buddha University showcased its drone technology centre at the Bharat Drone Mahotsav 2022 with student participation.",
    ...
    },
    {
      ...
      date: "2022-07-01",
      image:
        "https://static.wixstatic.com/media/bc6a73_c395997f244f43d5bccd5310bd8deae2~mv2.jpeg/v1/fill/w_749,h_329,al_c,q_80,enc_avif,quality_auto/11062b_fd5c21cdc57f4b19b00f8ec0988396fe_.jpeg",
      description:
        "GBU students actively engaged in drone manufacturing projects including delivery drones for smart solutions.",
      link:
        "https://www.amarujala.com/delhi-ncr/noida/gbu-students-are-making-delivery-drones-noida-news-noi6522566115",
    },
    {
      title: "GBU to Make History with First Drone Course in UP",
      date: "2022-05-20",
    ...
    },
    {
      ...
      date: "2022-06-15",
      image:
        "https://static.wixstatic.com/media/bc6a73_069991b6d1a843e8a6867111d103a6ab~mv2.jpeg/v1/fill/w_815,h_358,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/11062b_fd5c21cdc57f4b19b00f8ec0988396fe_.jpeg",
      description:
        "Gautam Buddha University sets up a dedicated Centre for Drone Studies focusing on research, training, and development.",
      link:
        "https://www.shiksha.com/news/college-gautam-buddha-university-establishes-centre-for-drone-studies-blogId-86279",
    },
  ],
};
export const coeidronetechnologiesData = {
  schoolCode: "SOICT",
  schoolName: "School of Information & Communication Technology",
  heading: "coeidrone technologies — SOICT",
  content: [],
};
