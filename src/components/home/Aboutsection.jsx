...
const StatItem = ({ label, rawValue, icon: Icon, color }) => {
  ...
  return (
    <div ref={ref} className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-2 sm:gap-4 p-2 sm:p-4 rounded-xl hover:bg-slate-50 transition-colors border border-transparent hover:border-slate-100">
      <div className={cn("p-3 rounded-xl shrink-0 bg-opacity-10", color.bg, color.text)}>
        <Icon className="w-5 h-5 sm:w-6 sm:h-6" />
      </div>
      <div>
        <div className="text-xl sm:text-2xl font-black text-slate-800 tracking-tight leading-none mb-1">
          {displayText}
        </div>
      ...
      <section className="bg-white py-6 sm:py-8 md:py-12 overflow-hidden border-b border-slate-100">
        <div className="mx-auto px-7 sm:px-14">
          <div className="flex flex-col lg:flex-row items-stretch gap-8 lg:gap-12">
            ...
            <div className="lg:w-5/12 flex flex-col justify-center items-center sm:items-start text-center sm:text-left py-2 sm:py-4 relative z-10">

              <h2 className="text-2xl sm:text-3xl font-bold text-center sm:text-left text-blue-800 mb-6 w-full">
                {aboutData.title || "Gautam Buddha University"}
              </h2>

              <div className="prose prose-slate prose-lg text-slate-600 mb-8 max-w-none text-center sm:text-left">
              ...
              {/* Stats Grid */}
              <div className="grid grid-cols-2 gap-x-2 sm:gap-x-6 gap-y-3 sm:gap-y-4 w-full mb-8">
              ...
              {aboutData.button1_text && aboutData.button1_url && (
                <div className="w-full flex justify-center sm:justify-start">
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-3.5 rounded-full bg-blue-600 hover:bg-blue-700 text-white font-bold tracking-wide transition-all shadow-lg shadow-blue-600/20 hover:-translate-y-0.5 hover:shadow-xl shadow-blue-600/30 text-sm sm:text-base"
                  >
            ...
            {/* Right Content (Image) */}
            <div className="lg:w-7/12 relative w-full min-h-[250px] sm:min-h-[350px] lg:min-h-[400px] rounded-2xl overflow-hidden shadow-md">

              <div className="relative w-full h-full min-h-[250px] sm:min-h-[350px]">
                <img
