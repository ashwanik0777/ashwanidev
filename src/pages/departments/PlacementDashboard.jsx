...
const PlacementDashboard = () => {
  ...
  const {
    ...
    reportDownloadLabel = "Download Report",
    contactInfo = {},
  } = placementData || {};
    ...
    <SearchableWrapper>
      <div className=" py-10 bg-gradient-to-br from-slate-50 to-blue-50">
        ...
        <div className="max-w-7xl mx-auto px-6 py-8 space-y-12">
          ...
          {((insideItems && insideItems.length > 0) || (brochure && brochure.link) || (report && report.link)) && (
          ...
          {((growth && growth.length > 0) || 
            ...
            (departmentPlacement && departmentPlacement.length > 0) || 
            (packageDistribution && packageDistribution.length > 0) || 
            (ugPgStats && (ugPgStats.ug || ugPgStats.pg)) || 
            (domesticInternational && (domesticInternational.domestic || domesticInternational.international))) && (
            <motion.section
              initial={{ opacity: 0, y: 60 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              {((sectorDistribution && sectorDistribution.length > 0) || (departmentPlacement && departmentPlacement.length > 0)) && (
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div className="text-center p-3 bg-green-50 rounded-lg">
                              <div className="text-2xl font-bold text-green-600">
                                {domesticInternational.domestic || "N/A"}
                              </div>
                              <div className="text-sm text-slate-600">Domestic</div>
                            </div>
                            <div className="text-center p-3 bg-orange-50 rounded-lg">
                              <div className="text-2xl font-bold text-orange-600">
                                {domesticInternational.international || "N/A"}
                              </div>
                              <div className="text-sm text-slate-600">
                                International
                              </div>
          ...
          {/* Placement Rules */}
          {((placementRules && placementRules.length > 0) || (resolvedContactInfo.people.length > 0 || resolvedContactInfo.emails.length > 0)) && (
            <motion.section
              initial={{ opacity: 0, y: 60 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {placementRules && placementRules.length > 0 ? (
                  <div className="space-y-4">
                ...
                {(resolvedContactInfo.people.length > 0 || resolvedContactInfo.emails.length > 0) ? (
                  <div className="bg-blue-50 rounded-lg p-6">
                    <h3 className="font-bold text-blue-800 mb-4 text-lg">
                      Contact Information
                    </h3>
                    <div className="space-y-4">
                      {resolvedContactInfo.people[0] && (
                        <div>
                          <p className="font-semibold text-blue-700">
                            {resolvedContactInfo.people[0]?.name}
                          </p>
                          <p className="text-blue-600 text-sm">
                            {resolvedContactInfo.people[0]?.role}
                          </p>
                        </div>
                      )}
                      {resolvedContactInfo.people[1] && (
                        <div>
                          <p className="font-semibold text-blue-700">
                            {resolvedContactInfo.people[1]?.name}
                          </p>
                          <p className="text-blue-600 text-sm">
                            {resolvedContactInfo.people[1]?.role}
                          </p>
                        </div>
                      )}
                      {resolvedContactInfo.emails && resolvedContactInfo.emails.length > 0 && (
                        <div className="pt-2 border-t border-blue-200">
                          {resolvedContactInfo.emails[0] && (
                            <div className="flex items-center text-blue-600 text-sm mb-1">
                              <Mail className="w-4 h-4 mr-2" />
                              {resolvedContactInfo.emails[0]}
                            </div>
                          )}
                          {resolvedContactInfo.emails[1] && (
